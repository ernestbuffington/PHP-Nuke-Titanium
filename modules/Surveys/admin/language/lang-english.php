...
define_once("_POLL_ADMIN_HEADER", "Surveys :: Modules Admin Panel");
define_once("_POLL_RETURNMAIN", "Return to Main Administration");
define_once("_POLLSADMIN","Surveys");
...
define_once("_CLEARVOTES","Clear votes?");
