...
define_once("_COMMENTSWARNING","The comments are owned by the poster. We aren't responsible for their content.");
...
define_once("_HTMLFORMATED","HTML Formated");
define_once("_PLAINTEXT","Plain Old Text");
define_once("_ONN","on...");
define_once("_SUBJECT","Subject");
define_once("_SURVEYCOM","Survey Comment Post");
define_once("_SURVEYCOMPRE","Survey Comment Post Preview");
...
define_once("_DIRECTCOM","Direct Survey Comment...");
define_once("_SENDAMSG","Send a Message");
define_once("_PASTSURVEYS","Past Surveys");
define_once("_LVOTES","votes");
define_once("_TOTALVOTES","Total Votes:");
define_once("_VOTING","Voting Booth");
define_once("_OTHERPOLLS","Other Polls");
define_once("_CURRENTSURVEY","Current Survey");
define_once("_CURRENTPOLLRESULTS","Current Poll Results");
define_once("_PREVIEW","Preview");
define_once("_REFRESH","Refresh");
define_once("_SURVEYS","Surveys");
define_once("_ATTACHEDTOARTICLE","- Attached to article:");
define_once("_SURVEYSATTACHED","Surveys Attached to Articles");
define_once("_LAST5POLLS", "Last 5 Surveys at");
define_once("_MOREPOLLS", "...more polls");
