...
global $prefix, $digits_color, $db;
$top = '10';
##############################################################################################################################################################################
# Top 10 read stories 
##############################################################################################################################################################################
echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._READSTORIES.'</strong></legend>';
echo '<br />';
...
if ($db->sql_numrows($result) > 0) 
{
    ...
    while ($row = $db->sql_fetchrow($result)) 
	{
	    ...
	    if($counter>0) 
		{
            echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('reads-icon-16.png','Top').'"> <a href="modules.php?name=News&amp;file=article&amp;sid='.$sid.'">'.$title.'</a> - ( <strong><font color="'.$digits_color.'">'.$counter.'</font></strong> '._READS.' )</li>';
        }
    }
...
echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._MOSTVOTEDSTORIES.'</strong></legend>';
echo '<br />';
    ...
    while ($row2 = $db->sql_fetchrow($result2)) {
        ...
        if($ratings>0) 
		{
            echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('speedometer-16.png','Top').'"> <a href="modules.php?name=News&amp;file=article&amp;sid='.$sid.'"> '.$title.'</a> - ( <font color="'.$digits_color.'"><strong>'.$ratings.'</strong></font> '._LVOTES.' )</li>';
        }
    }
    echo "</ol></div></legend></fieldset>";
}
...
echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._BESTRATEDSTORIES.'</strong></legend>';
echo '<br />';
    ...
    while ($row3 = $db->sql_fetchrow($result3)) {
        ...
        if($score>0) {
            ...
            echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('thumbs-up-16.png','Top').'"> <a href="modules.php?name=News&amp;file=article&amp;sid='.$sid.'">'.$title.'</a> - ( <strong><font color="'.$digits_color.'">'.$rate.'</font></strong> '._POINTS.' )</li>';
        }
    }
    echo "</ol></div></legend></fieldset>";
}
...
if ($articlecomm == 1) 
{
    ...
    if ($db->sql_numrows($result4) > 0) 
	{
       ...
       echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
       echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._COMMENTEDSTORIES.'</strong></legend>';
       echo '<br />';    
       ...
       echo '<ol>';
	    ...
	    while ($row4 = $db->sql_fetchrow($result4)) 
		{
		    ...
		    if($comments>0) 
			{
                echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('comments-16.png','Top').'"> <a href="modules.php?name=News&amp;file=article&amp;sid='.$sid.'">'.$title.'</a> - ( <strong><font color="'.$digits_color.'">'.$comments.'</font></strong> '._COMMENTS.' )</li>';
            }
        }
        echo "</ol></div></legend></fieldset>";
    }
...
if ($db->sql_numrows($result5) > 0) 
{
    ...
    echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
    echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._ACTIVECAT.'</strong></legend>';
    echo '<br />';
    echo "<div style=\"padding: 0px;\"><span class=\"option\"></span>";
    echo '<ol>';
    ...
    while ($row5 = $db->sql_fetchrow($result5)) 
	{
	    ...
	    if($counter>0) 
		{
            echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('comment-square-16.png','Top').'"> <a href="modules.php?name=News&amp;file=categories&amp;op=newindex&amp;catid='.$catid.'">'.$title,'</a> - ( <strong><font color="'.$digits_color.'">'.$counter.'</font></strong> '._HITS.' )</li>';
        }
    }
    echo "</ol></div></legend></fieldset>";
}
...
{
    echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
    echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._NEWSSUBMITTERS.'</strong></legend>';
    echo '<br />';
    ...
    while ($row7 = $db->sql_fetchrow($result7)) 
	{
	    ...
	    if($counter>0) 
		{
            echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('submit-icon-16.png','Top').'"> <a href="modules.php?name=Your_Account&amp;op=userinfo&amp;username=$uname">'.$uname.'</a> - ( <strong><font color="'.$digits_color.'">'.$counter,'</font></strong> '._NEWSSENT.' )</li>';
        }
    }
...
//        }
//        echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('speedometer-16.png','Top').'"> <a href="modules.php?name=Surveys&amp;pollID='.$id.'">'.$pollTitle.'</a> - ( '.$sum.' '._LVOTES.' )</li>';
...
{
    echo '<fieldset style="border-color: '.$fieldset_color.'; border-width: '.$fieldset_border_width.'; border-style: solid;">';
    echo '<legend align="center" id="Legend5" runat="server" visible="true" style="width:auto; margin-bottom: 0px; font-weight: bold;">'.$top.' '._MOSTACTIVEAUTHORS.'</strong></legend>';
    echo '<br />';
    ...
    while ($row11 = $db->sql_fetchrow($result11)) 
	{
	    ...
	    if($counter>0) 
		{
            echo '<li><img class="icons" align="absmiddle" width="16" src="'.img('admin-16.png','Top').'"> <a href="modules.php?name=Search&amp;query=&amp;author='.$aid.'">'.$aid.'</a> - ( '.$counter.' '._NEWSPUBLISHED.' )</li>';
        }
    }
