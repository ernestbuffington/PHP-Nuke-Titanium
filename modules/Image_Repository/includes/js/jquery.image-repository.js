...
//-------------------------------------------------------------------------
				...
				var content  = '<tr class="imagethumbs" id="image-' + response.nextid + '">'
					...
					content += '        <td class="row1" style="width:20%;height:30px;text-align:left;letter-spacing:1px;"><a data-id="' + response.nextid + '" class="code-popup" href="javascript:void(0);">' + lang_more_codes + '</a> | <a'+image_viewer+' href="' + nukeurl + '/' + upload_dir + '/' + response.image + '">' + lang_full + '</a> | <a data-id="' + response.nextid + ':::' + response.size + '" class="delete-image" href="javascript:void(0);">' + lang_delete + '</a></td>'
					content += '      </tr>'
					content += '	</table>'
					content += '	</td>'
					content += '</tr>'
				// var content  = '<tr class="imagethumbs" id="image-' + response.nextid + '">'
				// 	content += '  <td class="row1" style="width:20%; text-align:center;"><div class="thumbnail_border"><img src="' + upload_dir + '/thumbs/thumb_' + response.image + '" border="0" /></div></td>'					
				// 	content += '  <td class="row1" style="width:80%;">'
				// 	content += '    <table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline" id="imagetable">'
				// 	content += '      <tr>'
				// 	content += '        <td class="row1" style="width:20%;height:30px;text-align:right;letter-spacing:1px;">' + lang_directlink + '</td>'
				// 	content += '        <td class="row1" style="width:80%;height:30px;text-align:center;letter-spacing:1px;"><input class="glowing-border select-style" name="bbcode" onclick="this.select();" onmouseover="this.select();" style="cursor:copy;padding-left:4px;padding-right:4px;letter-spacing:1px;width:98%;" type="text" value="' + nukeurl + '/' + upload_dir + '/' + response.image + '" readonly /></td>'
				...
				// 	content += '      <tr>'
				// 	content += '        <td class="row1" style="width:20%;height:30px;text-align:right;letter-spacing:1px;">' + lang_options + '</td>'
				// 	content += '        <td class="row1" style="width:20%;height:30px;text-align:left;letter-spacing:1px;"><a data-id="' + response.nextid + '" class="code-popup" href="javascript:void(0);">' + lang_more_codes + '</a> | <a href="' + nukeurl + '/' + upload_dir + '/' + response.image + '" class="fancybox">' + lang_full + '</a> | <a data-id="' + response.nextid + ':::' + response.size + '" class="delete-image" href="javascript:void(0);">' + lang_delete + '</a></td>'
				// 	content += '      </tr>'
				// 	content += '	</table>'
				// 	content += '	</td>'
				// 	content += '</tr>'
