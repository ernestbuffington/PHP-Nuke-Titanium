...
$pagetitle = ": "._SP_ADMINMAIN." - "._SP_INACTIVESITES;
...
CloseTable();
echo "<br />";
title(_SP_ADMINMAIN." - "._SP_INACTIVESITES);
spmenu();
echo "<br />\n";
OpenTable();
$a = 0;
...
if($numrows > 0) {
  ...
  while($site_row = $db->sql_fetchrow($result)) {
    ...
    echo " <a href='".$admin_file.".php?op=SPActivate&amp;site_id=".$site_row['site_id']."'><img src='modules/$module_name/images/activate.png' border='0' alt='"._SP_ACTIVATE."' title='"._SP_ACTIVATE."'></a>";
