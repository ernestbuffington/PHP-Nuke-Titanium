...
function select_month() 
{
	...
	while(list($time) = $db->sql_fetchrow($result)) 
	{
        ...
        if ($month != $thismonth) 
		{
		    ...
		    echo "<img align=\"absmiddle\" width=\"20\" src=\"".img('calender-icon.png','Stories_Archive')."\"> <a href=\"modules.php?name=$module_name&amp;sa=show_month&amp;year=$year&amp;month=$getdate[2]&amp;month_l=$month\">$month, $year</a><br />";
...
function show_month($year, $month, $month_l) 
{
	...
	while ($row = $db->sql_fetchrow($result)) 
	{
		...
		$actions = "<a href=\"modules.php?name=News&amp;file=print&amp;sid=$sid\"><i class=\"fa fa-print\"></i></a>&nbsp;<a href=\"modules.php?name=News&amp;file=friend&amp;op=FriendSend&amp;sid=$sid\"><i class=\"fa fa-envelope\"></i></a>";
