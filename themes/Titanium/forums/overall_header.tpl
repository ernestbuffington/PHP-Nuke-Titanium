...
<table style="margin: auto; width: 680px; table-layout: fixed;" cellpadding="1" cellspacing="4" border="0">
  <tr>
    <td style="text-align: left; width: 170px;">
        ...
        <a href="{U_INDEX}" class="mainmenu"><strong>{L_MINI_INDEX}</strong></a>
    </td>    
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_members.png">
        </span>
        <a href="{U_MEMBERLIST}" class="mainmenu"><strong>{L_MEMBERLIST}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_search.png">
        </span>
        <a href="{U_SEARCH}" class="mainmenu"><strong>{L_SEARCH}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_groups.png">
        </span>
        <a href="{U_GROUP_CP}" class="mainmenu"><strong>{L_USERGROUPS}</strong></a>
    </td>    
  </tr>
  <tr>
    <td style="text-align: left; width: 170px;">
        ...
        <a href="{U_RANKS}" class="mainmenu"><strong>{L_RANKS}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_staff.png">
        </span>
        <a href="{U_STAFF}" class="mainmenu"><strong>{L_STAFF}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_stats.png">
        </span>
        <a href="{U_STATISTICS}" class="mainmenu"><strong>{L_STATISTICS}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_faq.png">
        </span>
        <a href="{U_FAQ}" class="mainmenu"><strong>{L_FAQ}</strong></a>
    </td>
  </tr>
  ...
  <tr>
    <td style="text-align: left; width: 170px;">
        ...
        <a href="{U_RULES}" class="mainmenu"><strong>{L_RULES}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_profile.png">
        </span>
        <a href="{U_PROFILE}" class="mainmenu"><strong>{L_PROFILE}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_message.png">
        </span>
        <a href="{U_PRIVATEMSGS}" class="mainmenu"><strong>{PRIVATE_MESSAGE_INFO}</strong></a>
    </td>
    <td style="text-align: left; width: 170px;">
        <span style="display:inline-block; vertical-align:middle; margin-top: -4px;">
            <img src="themes/{THEME_NAME}/forums/images/links/icon_mini_login.png">
        </span>
        <a href="{U_LOGIN_LOGOUT}" class="mainmenu"><strong>{L_LOGIN_LOGOUT}</strong></a>
    </td>
  </tr>
</table>
...
<table border="0" cellpadding="4" cellspacing="1" class="wtf col-12">
  <tr>
    <td align="center">{switch_quick_search.L_QUICK_SEARCH_FOR} <input class="post" type="text" name="search_keywords" size="15" /> {switch_quick_search.L_QUICK_SEARCH_AT} 
        ...
        <input class="myButton" type="submit" value="{L_SEARCH}" />
    </td>
  </tr>
</table>
</form>
