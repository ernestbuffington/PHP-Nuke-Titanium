    ...
    <td class="catHead">
      <table style="width: 100%;" border="0" cellpadding="4" cellspacing="1" class="forumline">
        <tr>
          ...
          <span>
            <span class="tooltip icon-sprite icon-info" style="float: left; margin-top: 2px;" title="{U_SEARCH_EXPLAIN}"></span><input type="text" class="post" name="username" maxlength="25" size="20" tabindex="1" value="" />&nbsp;<input type="submit" name="submituser" value="{L_LOOK_UP}" style="cursor: pointer;" class="myButton" /></td>
          </span>
        </tr>
      </table>
    </td>
