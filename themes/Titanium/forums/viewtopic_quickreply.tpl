...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
    <td class="catBottom" colspan="2" align="center" height="28">
      ...
      <input style="cursor:pointer;" type="submit" tabindex="5" name="preview" id="preview" class="myButton" value="{L_PREVIEW}" />
      <input style="cursor:pointer;" type="submit" id="submit" accesskey="s" tabindex="6" name="post" class="myButton" value="{L_SUBMIT}" />
    </td>
  </tr>
</table>
