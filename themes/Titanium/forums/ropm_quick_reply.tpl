...
<td class="catBottom" colspan="3" align="center" height="28">
    ...
    <input type="submit" tabindex="5" name="preview" id="preview" class="myButton" value="{L_PREVIEW}" />
    <input type="submit" id="submit" accesskey="s" tabindex="6" name="post" class="myButton" value="{L_SUBMIT}" />
</td>
</tr>
</form>
