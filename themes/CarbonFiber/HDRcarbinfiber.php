...
# RD Scripts v1.0 #
#-----------------#
addJSToBody(carbinfiber_js_dir.'menu.min.js');

$ads = ads(0);

echo '<section id="flex-container">';

echo '<div class="container" style="width: '.carbinfiber_width.'">';
...
# MENU SYSTEM
#################################################################################################################################################
echo '<div class="flex-item" style="width: 100%; height: 29px; background-image: url('.carbinfiber_hdr_images.'HDRnav_Bg_Stretch.png)">';       #
include(carbinfiber_theme_dir.'HDRnavi.php');                                                                                                   #
echo '</div>';                                                                                                                                  #
#################################################################################################################################################
echo '</td>';
