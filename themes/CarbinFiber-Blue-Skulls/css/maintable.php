...
.sideflames
{
   ...
   background-image: 
   url(../../../themes/<?=$theme_name?>/backgrounds/topright.png),
   url(../../../themes/<?=$theme_name?>/center/sidebox_blue_skulls_bottom_block_001.png);
  background-position:
    top right, /* this positions the first image - TheGhost add 8/2/2019 */
    bottom center; /* this positions the second image - TheGhost add 8/2/2019 */
  background-repeat:
...
background-image: 
    ...
    url(themes/<?=$theme_name?>/center/black_glass_with_blue_Skulls_article_and_index_bottom.png); /* bottom blue skulld - TheGhost add 08/04/2019 */
  background-position:
    top right, 
    bottom left; 
  background-repeat: 
...
background-image: 
    url(themes/<?=$theme_name?>/backgrounds/topright.png),                                         /* Top Black Glass - TheGhost add 08/04/2019 */
    url(themes/<?=$theme_name?>/center/black_glass_with_blue_Skulls_article_and_index_bottom.png); /* Bottom Blue Skulls - TheGhost add 08/04/2019 */
  background-position:
    top right, 
    bottom left; 
  background-repeat: 
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/* This is the Blue Skulls Bottom of the Articles Page and The index page                                                                                  */
.themeindexflames
{
background-color: black;	
background-image: 
    url(themes/<?=$theme_name?>/backgrounds/topright.png),                                         /* Top Black Glass    - TheGhost add 08/18/2019 */
    url(themes/<?=$theme_name?>/center/black_glass_with_blue_Skulls_article_and_index_bottom.png); /* Bottom Blue Skulls - TheGhost add 08/18/2019 */
  background-position:
    top right, 
    bottom center; 
  background-repeat: 
