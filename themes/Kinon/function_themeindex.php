...
global $anonymous, $tipath, $theme_name, $sid, $ThemeSel, $nukeurl, $customlang;
    ...
    if (!empty($topicimage)):
        ...
        $t_image = (file_exists(kinon_images_dir.'topics/'.$topicimage)) ? kinon_images_dir.'topics/'.$topicimage : $tipath.$topicimage;
...
table.themeindexblock {
    background: url(<?php echo THEME_INDEX_BACKGROUND; ?>); /* Kinon background - TheGhost add 08/04/2019 */
...
echo ''.$content.'</div>';	
echo '<div align="right">'.$posted.'<img src="themes/Kinon/images/invisible_pixel.gif" alt="" width="4" height="1" border="0" /><br />'.$datetime.' '.$topictext.' | '.$morelink.' '.$reads.'<img src="themes/Kinon/images/invisible_pixel.gif" alt="" width="4" height="1" border="0" /></div>';
CloseTable();
...
//echo '<table>';
//echo '<tr>';
//echo " <td style=\"width: 1px;\" valign =\"top\"><img src=\"themes/Kinon/images/invisible_pixel.gif\" alt=\"\" width=\"1\" height=\"1\" border=\"0\" /></td>\n";
//echo '</tr>';
//echo '</table>';
//echo '</middle>';
