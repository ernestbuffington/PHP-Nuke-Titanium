...
table.themearticleblock {
    background: url(<?php echo THEME_ARTICLE_BACKGROUND; ?>); /* Kinon background - TheGhost add 08/04/2019 */
...
echo ''.$content.'</div>';	
echo '<div align="right">'.$posted.'<img src="themes/Kinon/images/invisible_pixel.gif" alt="" width="4" height="1" border="0" /><br />'.$reads.'<img src="themes/Kinon/images/invisible_pixel.gif" alt="" width="4" height="1" border="0" /></div>';
CloseTable();
