...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
  ...
  <tr>
    <td class="catBottom" colspan="2" style=" text-align: center;">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="myButton" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></td>
  </tr>
</table>
<!--	QUICK REPLY PANEL	-->
</form>