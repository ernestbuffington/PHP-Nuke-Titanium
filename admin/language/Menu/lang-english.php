...
/*=======================================================================
 ...
 =======================================================================*/
define("_MENU","Menu");
define("_MENU_ADMINTITLE","Administration Menu");
...
define("_MENU_ATTNSUPPRCAT","Attention&nbsp;!!&nbsp;&nbsp; You cannot cancel if you delete a category ! (The 'Cancel' button does not re-create the deleted category)");
define("_MENU_WEIGHT","Weight");
define("_MENU_CATEGORIES","Categories");
...
define ("_MENU_NO","No");
/* Added by Menu Paramétrable (Customize Menu) v2.1 installation script */
...
define("_MENU_JSSAVEBEFORE","Do you want to save your modifications before deleting this category ?");
...
/* End of Menu Paramétrable v2.1 modifications */
/* Titanium Portal Menu v3.0 */
...
/* End of Titanium Portal Menu v3.0 modifications */
