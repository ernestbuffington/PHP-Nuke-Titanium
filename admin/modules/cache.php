...
function cache_header() 
{
    ...
    $enabled = ($cache->valid) ? "<font color=\"green\"><strong>" . _CACHE_ENABLED . "</strong></font>" : "<font color=\"red\">" . _CACHE_DISABLED . "</font> (<a href=\"$admin_file.php?op=howto_enable_cache\">" . _CACHE_HOWTOENABLE . "</a>)";
    ...
    OpenTable();
    echo "<div align=\"center\"><a href=\"$admin_file.php?op=cache\"><strong>" . _CACHE_HEADER . "</strong></a></div>\n";
    echo "<div align=\"center\">\n[ <a href=\"$admin_file.php\">" . _CACHE_RETURN . "</a> ]</div><br />\n";
