...
if (!is_admin()) { echo "Access Denied"; die(); }
...
function BlocksAdmin() 
{
    ...
    echo "<div align=\"center\">\n<a href=\"$admin_file.php?op=blocks\"><strong>" . _BLOCK_ADMIN_HEADER . "</strong></a></div>\n";
...
function block_show($bid) 
{
    ...
    include_once(NUKE_BASE_DIR.'header.php');
    OpenTable();
    echo "<div align=\"center\" class=\"option\">"._BLOCKSADMIN.": "._FUNCTIONS."<br /><br />"
...
function NewBlock($bid='') 
{
	...
	{
        if(@in_array($gid,$ingroups) AND $o6 == 'SELECTED') 
		{ 
		  $sel = "selected"; 
		} 
		else 
