...
function save_settings($sub) 
{
    ...
    switch($sub) {
        ...
        case 10:
            ...
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$admin_fc_status."' WHERE evo_field='admin_fc_status'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$admin_fc_attempts."' WHERE evo_field='admin_fc_attempts'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$admin_fc_timeout."' WHERE evo_field='admin_fc_timeout'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$admin_iphub_status."' WHERE evo_field='iphub_status'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$admin_iphub_key."' WHERE evo_field='iphub_key'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$admin_iphub_ctime."' WHERE evo_field='iphub_cookietime'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$recapcolor."' WHERE evo_field='recap_color'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$recaplang."' WHERE evo_field='recap_lang'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$recap_site_key."' WHERE evo_field='recap_site_key'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$recap_private_key."' WHERE evo_field='recap_priv_key'");
 ...
 ******************************************************/
         ...
         case 12:
            ...
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_alert_status."' WHERE evo_field='pm_alert_status'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_cookie_name."' WHERE evo_field='pm_cookie_name'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_cookie_minutes."' WHERE evo_field='pm_cookie_minutes'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_cookie_seconds."' WHERE evo_field='pm_cookie_seconds'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_overlay_color."' WHERE evo_field='pm_overlay_color'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_button_color."' WHERE evo_field='pm_button_color'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_button_color2."' WHERE evo_field='pm_button_color2'");
            $db->sql_query("UPDATE ".$prefix."_evolution SET evo_value='".$pm_alert_sound."' WHERE evo_field='pm_alert_sound'");
