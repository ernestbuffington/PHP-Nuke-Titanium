 ...
 ******************************************************/
                        ...
                        if ($row = $db->sql_fetchrow($result))
                        {
                                ...
                                if (count($bcc_list_ary))
                                {
                                    ...
                                    //     die('<pre>'.var_export($addbcc, true).'</pre>');
                                    ...
                                    //         'body'      => str_replace($notify_body_pattern, $notify_body_replace, $lang['topic_notify'])
                                    //     );

                                    //     evo_phpmailer2($phpmailer_parameters);
                                    // }
                                    ...
                                    */
                                    ...
                                    $content = str_replace( '{U_TOPIC}', $email_data['topic_link'], $content );
                                    ...
                                    $content = str_replace( '{U_STOP_WATCHING_TOPIC}', $email_data['stop_watching'], $content );
