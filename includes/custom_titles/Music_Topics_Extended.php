...
$newpagetitle = '';
   ...
   $user_prefix, 
    ...
    $facebook_ogimage = "<meta property=\"og:image\" content=\"".HTTPS."$domain/upload/upu/files/$name.png\">\n";
    else
    $facebook_ogimage = "<meta property=\"og:image\" content=\"".HTTPS."music.86it.us/images/titanium/$name.png\">\n";
	 ...
	 $facebook_ogurl = "<meta property=\"og:url\" content=\"".HTTPS."music.86it.us/modules.php?name=Music_Topics_Extended&tt=$tt\">\n"; 
