...
if ($tt)
redirect("".HTTPS."$domain/modules.php?name=Music_Topics_Extended&tt=$tt");
if (($fb_source == "timeline") && ($topicid))
redirect("".HTTPS."$domain/modules.php?name=Music_Topics_Extended&tt=$topicid");
...
$newpagetitle = '';
   ...
   $user_prefix, 
    ...
    $facebook_ogimage = "<meta property=\"og:image\" content=\"".HTTPS."music.86it.us/upload/upu/files/$name.png\">\n";
    else
    $facebook_ogimage = "<meta property=\"og:image\" content=\"".HTTPS."music.86it.us/images/titanium/Music.png\">\n";
	 ...
	 if($topicid)
	 $facebook_ogurl = "<meta property=\"og:url\" content=\"".HTTPS."music.86it.us/modules.php?name=Music_Topics_Extended&tt=$topicid\">\n"; 
     else
	 if($tt)
	 $facebook_ogurl = "<meta property=\"og:url\" content=\"".HTTPS."music.86it.us/modules.php?name=Music_Topics_Extended&tt=$topicid\">\n"; 
     else
	 $facebook_ogurl = "<meta property=\"og:url\" content=\"".HTTPS."music.86it.us/modules.php?name=Music_Topics\">\n"; 
	 if($topicid)
