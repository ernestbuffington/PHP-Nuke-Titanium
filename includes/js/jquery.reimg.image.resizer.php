...
if ($img_resize) 
{
	...
	$JStoBody .= '  var reimg_loadingStyle      = "width: 126px; height: 22px; background: url(./includes/css/images/reimg-image-resizer/loading.gif) top center no-repeat;";'.PHP_EOL;
